...
const PLUGIN_CATEGORIES: Record<string, Array<{ type: string; label: string }>> = {
  ...
  "Time Effects": [
    ...
    { type: "ping-pong-delay", label: "Ping-Pong Delay" },
  ],
  Dynamics: [
  ...
  "Filters & EQ": [
    // Matches the registered type names in EffectModule.EFFECT_TYPES.
    { type: "eq3", label: "3-Band EQ" },
    { type: "lowpass", label: "Low-Pass Filter" },
    { type: "highpass", label: "High-Pass Filter" },
    { type: "bandpass", label: "Band-Pass Filter" },
    { type: "notch", label: "Notch Filter" },
    { type: "peaking", label: "Peaking EQ" },
    { type: "lowshelf", label: "Low Shelf" },
    { type: "highshelf", label: "High Shelf" },
    { type: "allpass", label: "All-Pass" },
  ],
  Distortion: [
  ...
  Modulation: [
    ...
    { type: "ring-modulator", label: "Ring Modulator" },
    { type: "pitch-shifter", label: "Pitch Shifter" },
    { type: "frequency-shifter", label: "Frequency Shifter" },
  ],
  Advanced: [
